...
export const fetchUser = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      "https://guardiansofadelia.herokuapp.com/api/current_user",
      {
...
export const updateUser = (values) => async (dispatch) => {
  try {
    const res = await tokenService.requestWithAccessToken(
      "https://guardiansofadelia.herokuapp.com/api/profile",
      "post",
      values
    );
...
export const buyProduct = (values) => async (dispatch) => {
  try {
    const res = await tokenService.requestWithAccessToken(
      "https://guardiansofadelia.herokuapp.com/api/products",
      "post",
      values
    );
